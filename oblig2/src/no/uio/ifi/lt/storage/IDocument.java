 ...
 * Matched against a {@link IQuery}. For the sake of simplicity, 
 * this interface does not define a fielded document model.
 * @see IQuery
 */
public interface IDocument {	
	...
	/**
	 * Returns a string that encodes arbitrary extra meta data for this document.
