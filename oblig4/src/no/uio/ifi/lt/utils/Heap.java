...
public class Heap<D, R extends Comparable<R>> implements Iterable<HeapItem<D, R>> {
	...
	/**
	 * Returns true if the heap is empty, i.e., if it contains no elements.
	...
	/**
	 * Clears the heap, i.e., logically resets it back to having no elements.
	 */
	public void clear() {
		this.size = 0;
	}
	...
	/**
	 * Utility method that swaps 2 identified entries in the heap's backing array.
	...
	/**
	 * Deletes the current root element. A new root element takes its place.
	 */
