...
/**
 * Defines an inverted index, i.e., a set of posting lists and other associated
 * data. The inverted index is at the heart of any search engine.
 */
public interface IInvertedIndex {
	...
	/**
	 * Returns the {@link IDocumentStore} over which the index was created.
